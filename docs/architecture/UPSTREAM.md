...
* 기준 고정 커밋: `70d9e2d704d88da2e81baa8b09e21523593efa18`
* HOP 작업 브랜치: `main`
...
* `core/bridge-factory`, `core/tauri-bridge`, `core/desktop-events`, `core/font-loader`: 데스크톱 런타임, 파일 이벤트, 로컬 번들 폰트 연동
* `command/commands/file`, `command/shortcut-map`: 데스크톱 파일 명령과 HOP 단축키
* `ui/dialog`, `ui/toolbar`, `ui/custom-select`, `ui/print-dialog`: HOP UI 보정과 인쇄 준비
